...
- **fast** → `Skill(skill: "bad-research:bad-research-fast")` (then the slim citation-grounding pass + slim critic before step 15 polish; its breadth branch spawns K parallel researchers for a wider mid-tier answer)
- **full** → `Skill(skill: "bad-research:bad-research-2-width-sweep")` (full path)
